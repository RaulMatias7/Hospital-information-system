        ...
        $Sintoma = $(this).attr('data-id');
           $.post('relat.php', {acao: 'Nova_Busca', id: $Sintoma}, function(retorno){
                ...
                $.getJSON("http://localhost/SBLSH_/relat.php/Nova_BuscaSOCORRO/" + $Sintoma, function(Socorros) {
                   $.getJSON("http://localhost/SBLSH_/relat.php/Nova_Causas/" + $Sintoma, function(Causabd) {
                   $.getJSON("http://localhost/SBLSH_/relat.php/Nova_prev/" + $Sintoma, function(prev) {
                   $.getJSON("http://localhost/SBLSH_/relat.php/Nova_Hosp/" + $Sintoma, function(Hosp) {
                if(resposta=="nao_achou"){
                    ...
                    $('.saida3').text("Podes tratar o/a "+dado.replace('"','').replace('"','')+(" no ")+nomeH.replace('"','').replace('"',''));
                    ...
                    // causas
                    var list = document.querySelector(".saida2 ul");
                    list.innerHTML ="";
                    var myData = JSON.stringify(ret(prev));
                    var myArray = myData.split(',');
                    console.log(myArray);
                    ...
                    // Prevencao
                    var list = document.querySelector(".saida1 ul");
                    list.innerHTML ="";
                    var myData = JSON.stringify(ret(Causabd));
                    var myArray = myData.split(',');
                    console.log(myArray);
           ...
           $("#versocorro").click(function(event) {
            ...
            $("#prevencao").click(function(event) {
                event.preventDefault();
                $("#prevs").fadeIn(2000);
                $("#diagn").text( 'Como é causado/a?').css('color','red');
                $(".infodasdoencas").hide();
                $("#Causas1").hide();
                $("#versocorro").show();
                $("#causas").show();
            ...
            $("#VerHosp").click(function(event) {
                event.preventDefault();
                $("#Causas3").fadeIn(2000);
                $("#diagn").text('Hospital!').css('color','red');
                $(".infodasdoencas").hide();
                $("#Causas1").hide();
                $("#versocorro").show();
                $("#causas").show();
