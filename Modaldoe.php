    ...
    <div class="modal-dialog dial" role="document">
        <div class="modal-content cont">
            ...
            <div class="modal-header bg-primary">
                <?php $dados=listarDados("doencas","31");
            ...
            <div class="modal-body rolagem" data-spy="scroll" data-target="cont1">
                ...
                <div class="container-fluid">
                     <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">O que é <?php echo $doencas->Doenca; ?>?</h2>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="letraS alinhar text-justify"><?php echo $doencas->Causas; ?> </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">Síntomas da Doença?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doencas->sintomas_id; ?> </p>
                        </div>
                    </div>
                  <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">Metódos de Prevenção?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doencas->Prevencao; ?> </p>
                        </div>
                    </div>
                </div>
            </div>
