    ...
    case 'listarDoenca':
        if (listarDados("doencas")): 
            ...
            <tr>
              ...
              <td scope="col"><?php echo $adm->Prevencao; ?></td>
              <td scope="col"><?php echo $adm->Causas; ?></td>
              <td scope="col"><?php echo substr($adm->sintomas_id,0,50).'...'; ?></td>
              <td scope="col"><?php echo substr($adm->Descricao,0,100).'...';?></td>
              <td scope="col"><?php echo $adm->markers_id; ?></td>
              <td><a href="#" id="btn_edit" data-id="<?php echo $adm->id; ?>"><i class="icon-edit btn-lg"></i></a></td>
              <td><a href="#" id="btn_excluir" data-id="<?php echo $adm->id; ?>"><i class="icon-delete btn-lg"></i></a></td>
            </tr>
        <?php
  ...
  case 'form_edit_doenca': 
        ...
        <form action="" name="form_edit_doenca" method="post" class="letraS bg-white">
           ...
           <div class="form-group">
            ...
            <input type="hidden" name="id" value="<?php echo $dados->id; ?>">
             <div class="form-group">
        <label class="text-black " for="id_hosptal"> Hospitais</label>
    ...
    <div class="col-md-6">
     <div class="form-group">
        <label class="text-black" for="Causas">Causas</label>
        <textarea cols="30" rows="4" name="Causas" autocomplete="off" class="font-weight-bold form-control" placeholder="Causas"><?php echo $dados->Prevencao; ?></textarea>
    </div>  
        </div>
        <div class="col-md-6">
     <div class="form-group">
        <label class="text-black " for="Prevencao">Prevenção</label>
        <textarea cols="30" rows="4" name="Prevencao" autocomplete="off" class="font-weight-bold form-control" placeholder="Prevenção"><?php echo $dados->Causas; ?></textarea>
    </div>
</div>
</div>
    <div class="form-group">
            ...
            <img src="images/load.GIF" class="load" alt="Carregando" style="width: 180px; display: none;">
            <button type="submit" class="btn btn-primary text-white">Actualizar</button>
            <button type="button" class="btn btn-primary text-white" id="btn_1">mais campos</button>
            <button type="button" class="btn btn-primary text-white collapse" id="btn_2">campo anterior</button>
              ...
              <form action="" name="form_edit_hospital" method="post" class="letraS bg-white">
                  <div class="row">
                      <div class="col-md-6">
                       ...
                       <div class="form-group">
                          <label class="text-black" for="endereco">Município</label>
                          <input type="text" name="Municipio" value="<?php echo $dados->Municipio?>" class="form-control" autocomplete="off" placeholder="Município">
                        </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
