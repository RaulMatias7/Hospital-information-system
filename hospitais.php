    ...
    <div class="site-blocks-cover inner-page overlay"  data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="ah2">Hospitais</h1>
          <span class="caption d-block text-white letraS">Localize um hopital mais perto de si e saiba mais sobre as suas especialidade.
          </span>
            </div>
        </div>
    </div>
    ...
    <div class="p-4">
        <div class="container">
            <div class="row">
               ...
               $result = $pdo->select("SELECT * FROM markers order by name LIMIT $inicio,$maximo");
               ...
               $pgs = ceil($total / $maximo);
                                    $i=0;
               $nome="Lucrecio_";
                       foreach ($result as $markers) :
                           ?>

                       <div class="col-md-6 col-lg-4 mb-5">
                       <div class="media-image">
                           <figure class="foto-legenda">
                               <img src="images/<?php echo $markers['id']?>/<?php echo $markers['imagem']?>" alt=" Erro de Image " class="img-fluid imag">
                               <figcaption>
                                   <h4 class="text-primary"><?php echo $markers['Doenca'] ?></h4>
                                   <p> Leia mais sobre esta Doença.</p>
                               </figcaption>
                           </figure>
                       <div class="media-image-body">

                           <h2 class="ah2"><?php echo $markers['name'] ?></h2>


                           <p class="letraS"><b>Enderesso:</b> <?php echo $markers['address']; ?>,<?php echo $markers['Provincia']; ?>, <?php echo $markers['Municipio']; ?> </p>
                           <p class="letraS"><b>Latitude:</b> <?php echo $markers['lat']; ?></p>
                           <p class="letraS"><b>Longitude:</b> <?php echo $markers['lng']; ?></p>
...
$dadosdoenca= $pdo->query("select * from markers order by name");
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-header bg-primary">
                    ...
                    <h5 class="modal-title text-white ah2"><?php echo $markers->name?></h5>
                ...
                <div class="container-fluid">
                     <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">O que é <?php echo $doenca->Doenca; ?>?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doenca->Descricao; ?> </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">Causas da Doença?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doenca->Causas; ?> </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">Síntomas da Doença?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doenca->sintomas_id; ?> </p>
                        </div>
                    </div>
                  <div class="row">
                        <div class="col-12">
                            <h2 class="letraS alinhar text-justify">Metódos de Prevenção?</h2>
                            <p class="letraS alinhar text-justify"><?php echo $doenca->Prevencao; ?> </p>
                        </div>
                    </div>
                </div>
                </div>
