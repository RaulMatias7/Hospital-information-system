        ...
        <div id="id_EditD" class="collapse ">
            ...
            <table class="table table-bordered table-striped tabela_doenca corpo122">
                ...
                <tr>
                    ...
                    <th scope="col" style="background-color: #d94808; color: white;">Prevenção</th>
                    <th scope="col" style="background-color: #d94808; color: white;">Causas</th>
...
<div class="row">
    <div class="col-md-12" id="id_tabela1">
        <div class="row container"  style="background-color: #d94808; margin-left: 0%">
            <div class="col-md-9">
                <h5 class="card-header" style="background-color: #d94808; color: rgb(255,255,255);">Visitas por cidade</h5>
            </div>
            <div class="col-md-3" >
    ...
    <div class="col-md-12" id="id_tabela2">
            <div class="row container"  style="background-color: #d94808; margin-left: 0%">
                <div class="col-md-9">
                    <h5 class="card-header" style="background-color: #d94808; color: rgb(255,255,255);">visitas por pagina</h5>
                </div>
                <div class="col-md-3" >
