      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          ...
          <span class="caption d-block text-white letraS">Esta área está reservado para fazeres a consulta e localizares o hospital.</span>
           <a href="Hospitais.php"><span class="btn btn-primary text-white px-4 letraS pulse">Ache um hospital</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="row container" >
            ...
            <div  class="collapse" id="Resultado">      
                <table  class="table table-bordered table-striped " >
                    ...
                    <div id="prevs" class="collapse">
                        <h2 style="font-size: 1.4rem"> é causado da seguinte forma!</h2>
                       <p>
                             <div class="saida2 prevss" style="min-height: 125px;">
                                 <ul class="text-black letraS bg-white"></ul>
                             </div>
                       </p>
                    </div>
                    <div id="Causas1" class="collapse">
                        <h2 style="font-size: 1.4rem">Passos a serem seguidos.</h2>
                       <p>
                             <div class="saida1 " style="min-height: 125px;">
                                 <ul class="text-black letraS bg-white"></ul>
                             </div>
                       </p>
                    </div>
                     <div id="Causas3" class="collapse text-black letraS bg-white">
                      <p class="saida3 " style="font-size: 1.2rem"></p>
                    </div>
                  </div>
                  <a href="#" class=" btn btn-outline-secondary btn-sm" id="versocorro">primeiro socorro</a>
                  <a href="#" class=" btn btn-outline-secondary btn-sm" id="prevencao">Causas</a>
                  <a href="#" class=" btn btn-outline-secondary btn-sm" id="causas">Prevenção</a>
                  <a href="#" href="#" class="btn btn-outline-secondary btn-sm collapse" id="VerRESULT">ver resultado</a>
                  <a href="#" class=" btn btn-outline-secondary btn-sm" id="VerHosp">Hospitais</a>
                    </p>                                                     
                       </td>
                    </tbody>
