...
<div id="atual">
    ...
    <div class="col-md-6">
     <div class="form-group">
        <label class="text-black ah3" for="Causas">Causas</label>
        <textarea cols="30" rows="4" name="Causas" autocomplete="off" class="font-weight-bold form-control" placeholder="Causas"></textarea>
    </div>  
        </div>
        <div class="col-md-6">
     <div class="form-group">
        <label class="text-black ah3" for="Prevencao">Prevenção</label>
        <textarea cols="30" rows="4" name="Prevencao" autocomplete="off" class="font-weight-bold form-control" placeholder="Prevenção"></textarea>
    </div>
</div>
</div>
    <div class="form-group">
...
<!-- Hospital -->
<form id="cadHosp" action="ajax/controles_AD_DE.php" enctype="multipart/form-data"  method="POST" class="p-1 border border-primary" style="background-color: rgba(0,0,0,0.2)">
   <div class="row">
              <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="" id="maiscapHosp">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="text-black ah3" for="imagem">Imagem do Hospital </label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="text-black ah3" for="horario">Horário</label>
                    <input type="text" name="horario" class="form-control" autocomplete="off" placeholder="Horário de atendimento">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                  <label class="text-black ah3" for="servico">Serviços ou Especialidades</label>
                    <textarea cols="30" rows="4" name="servico" autocomplete="off" class="font-weight-bold form-control" placeholder="Especialidades"></textarea>
                </div>
            </div>
        </div>
    </div>
    <input name="CAdHosp" type="submit" class="btn btn-primary text-white" value="cadastrar">
    <input type="button"  class="btn btn-primary text-white" value="outros campos" id="maicapos">
    <input type="button"  class="btn btn-primary text-white collapse" value="campos anteriores" id="mencapos">
